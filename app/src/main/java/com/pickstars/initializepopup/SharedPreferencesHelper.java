...
public class SharedPreferencesHelper {
    ...
    public static void init(Context applicationContext, String spName) {
        if (TextUtils.isEmpty(spName)) {
            throw new NullPointerException("当 SharedPreferencesHelper 初始化时，SharedPreferences name 为 null！");
        }
        if (applicationContext == null) {
            throw new NullPointerException("当 SharedPreferencesHelper 初始化时，applicationContext 为 null！");
        }
    ...
    public static void removeKey(String key) {
        if (mSharedPreferences != null) {
            ...
            Log.e(TAG, "SharedPreferences 为 null");
        }
    }
    ...
    public static void applyStringSet(String key, Set<String> defValue) {
        if (mSharedPreferences != null && null == defValue) {
